    ...
    stages {
        ...
        post {
            ...
            failure {
                ...
                emailext to: "dcarho@hotmail.com", body: "<b>Los test fallaron.</b><br>Project: ${env.JOB_NAME} <br>Build Number: ${env.BUILD_NUMBER} <br> URL de build: ${env.BUILD_URL}", mimeType: 'text/html', subject: "ERROR CI: Project name -> ${env.JOB_NAME}"
