    ...
    stages {
        ...
        post {
         ...
         success {
                ...
                githubNotify status: 'SUCCESS', account: 'dcarho', credentialsId: 'github-pass',  repo: 'software-quality', context: 'Activity3 Test', description: 'This is an example'            
             
         }  
         failure {
            
                echo 'This will run only if fails'
                githubNotify status: 'FAILURE', account: 'dcarho', credentialsId: 'github-pass',  repo: 'software-quality', context: 'Activity3 Test', description: 'This is an example'
